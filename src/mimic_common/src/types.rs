...
impl ToTokens for Cardinality {
    fn to_tokens(&self, tokens: &mut TokenStream) {
        ...
        tokens.extend(quote!(::mimic::common::types::Cardinality::#ident))
    }
}
...
impl ToTokens for ConstantType {
    fn to_tokens(&self, tokens: &mut TokenStream) {
        ...
        tokens.extend(quote!(::mimic::common::types::ConstantType::#ident))
    }
}
...
impl PrimitiveType {
    ...
    pub fn as_type(&self) -> TokenStream {
        match self {
            Self::Bool => quote!(bool),
            Self::Blob => quote!(::mimic::base::types::Blob),
            Self::Decimal => quote!(::mimic::base::types::Decimal),
            Self::Float32 => quote!(f32),
            Self::Float64 => quote!(f64),
            Self::Int => quote!(::mimic::base::types::Int),
            Self::Int8 => quote!(i8),
            Self::Int16 => quote!(i16),
            Self::Int32 => quote!(i32),
            Self::Int64 => quote!(i64),
            Self::Int128 => quote!(i128),
            Self::Principal => quote!(::mimic::base::types::Principal),
            Self::Nat => quote!(::mimic::base::types::Nat),
            Self::Nat8 => quote!(u8),
            Self::Nat16 => quote!(u16),
            Self::Nat32 => quote!(u32),
            Self::Nat64 => quote!(u64),
            Self::Nat128 => quote!(u128),
            Self::Relation => quote!(::mimic::base::types::Relation),
            Self::RelationSet => quote!(::mimic::base::types::RelationSet),
            Self::Text => quote!(::std::string::String),
            Self::Unit => quote!(::mimic::base::types::Unit),
            Self::Ulid => quote!(::mimic::base::types::Ulid),
        }
    }
...
impl ToTokens for PrimitiveType {
    fn to_tokens(&self, tokens: &mut TokenStream) {
        ...
        tokens.extend(quote!(::mimic::common::types::PrimitiveType::#ident))
    }
}
...
impl ToTokens for PrimitiveGroup {
    fn to_tokens(&self, tokens: &mut TokenStream) {
        ...
        tokens.extend(quote!(::mimic::common::types::PrimitiveGroup::#ident))
    }
}
...
impl ToTokens for SortDirection {
    fn to_tokens(&self, tokens: &mut TokenStream) {
        ...
        tokens.extend(quote!(::mimic::common::types::SortDirection::#ident))
    }
}
...
impl ToTokens for StoreType {
    fn to_tokens(&self, tokens: &mut TokenStream) {
        ...
        tokens.extend(quote!(::mimic::common::types::StoreType::#ident))
    }
}
