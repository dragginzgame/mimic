...
impl ToTokens for PrimitiveType {
    fn to_tokens(&self, tokens: &mut TokenStream) {
        let ty = match self {
            ...
            Self::Blob => quote!(::mimic_base::types::Blob),
            Self::Decimal => quote!(::mimic_base::types::Decimal),
            Self::F32 => quote!(f32),
            Self::F64 => quote!(f64),
            Self::I8 => quote!(i8),
            Self::I16 => quote!(i16),
            ...
            Self::Principal => quote!(::mimic_base::types::Principal),
            Self::String => quote!(String),
            Self::Timestamp => quote!(::mimic_base::types::Timestamp),
            Self::Ulid => quote!(::mimic_base::types::Ulid),
            Self::U8 => quote!(u8),
            Self::U16 => quote!(u16),
            Self::U32 => quote!(u32),
            Self::U64 => quote!(u64),
