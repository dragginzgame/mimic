...
pub mod prelude {
    pub use crate::{
        ...
        traits::{
            EntityDyn, EntityFixture, EntityId as _, Filterable, Inner as _, NumCast, Orderable,
            Ordering, Path, Selector as _, SortKeyValue as _, Validate as _, ValidateCustom,
