...
impl Path for Blob {
    ...
    const PATH: &'static str = "mimic::base::types::Blob";
}
...
impl Path for Decimal {
    ...
    const PATH: &'static str = "mimic::base::types::Decimal";
}
...
impl Path for Int {
    ...
    const PATH: &'static str = "mimic::base::types::Int";
}
...
impl Path for Nat {
    ...
    const PATH: &'static str = "mimic::base::types::Nat";
}
...
impl Path for Principal {
    ...
    const PATH: &'static str = "mimic::base::types::Principal";
}
...
#[primitive(variant = "Relation", path = "types::prim::Relation")]
pub struct Relation {}

impl Path for Relation {
    const IDENT: &'static str = "Relation";
    const PATH: &'static str = "mimic::base::types::Relation";
}
...
impl Path for RelationSet {
    ...
    const PATH: &'static str = "mimic::base::types::RelationSet";
}
...
impl Path for Ulid {
    ...
    const PATH: &'static str = "mimic::base::types::Ulid";
}
...
impl Path for Unit {
    ...
    const PATH: &'static str = "mimic::base::types::Unit";
}
