...
impl PrimitiveType {
    ...
    pub fn as_type(&self) -> TokenStream {
        match self {
            ...
            Self::Float32 => quote!(::mimic::types::prim::Float32),
            Self::Float64 => quote!(::mimic::types::prim::Float64),
            Self::Int => quote!(::mimic::types::prim::Int),
            Self::Int8 => quote!(::mimic::types::prim::Int8),
            Self::Int16 => quote!(::mimic::types::prim::Int16),
            Self::Int32 => quote!(::mimic::types::prim::Int32),
            Self::Int64 => quote!(::mimic::types::prim::Int64),
            Self::Int128 => quote!(::mimic::types::prim::Int128),
            Self::Key => quote!(::mimic::types::prim::Key),
            Self::KeySet => quote!(::mimic::types::prim::KeySet),
            Self::Principal => quote!(::mimic::types::prim::Principal),
            Self::Nat => quote!(::mimic::types::prim::Nat),
            Self::Nat8 => quote!(::mimic::types::prim::Nat8),
            Self::Nat16 => quote!(::mimic::types::prim::Nat16),
            Self::Nat32 => quote!(::mimic::types::prim::Nat32),
            Self::Nat64 => quote!(::mimic::types::prim::Nat64),
            Self::Nat128 => quote!(::mimic::types::prim::Nat128),
