...
impl PrimitiveType {
    ...
    pub fn as_type(&self) -> TokenStream {
        match self {
            Self::Account => quote!(::mimic::def::types::Account),
            Self::Bool => quote!(::mimic::def::types::Bool),
            Self::Blob => quote!(::mimic::def::types::Blob),
            Self::Decimal => quote!(::mimic::def::types::Decimal),
            Self::Float32 => quote!(::mimic::def::types::Float32),
            Self::Float64 => quote!(::mimic::def::types::Float64),
            Self::Int => quote!(::mimic::def::types::Int),
            Self::Int8 => quote!(::mimic::def::types::Int8),
            Self::Int16 => quote!(::mimic::def::types::Int16),
            Self::Int32 => quote!(::mimic::def::types::Int32),
            Self::Int64 => quote!(::mimic::def::types::Int64),
            Self::Int128 => quote!(::mimic::def::types::Int128),
            Self::Key => quote!(::mimic::def::types::Key),
            Self::KeySet => quote!(::mimic::def::types::KeySet),
            Self::Principal => quote!(::mimic::def::types::Principal),
            Self::Nat => quote!(::mimic::def::types::Nat),
            Self::Nat8 => quote!(::mimic::def::types::Nat8),
            Self::Nat16 => quote!(::mimic::def::types::Nat16),
            Self::Nat32 => quote!(::mimic::def::types::Nat32),
            Self::Nat64 => quote!(::mimic::def::types::Nat64),
            Self::Nat128 => quote!(::mimic::def::types::Nat128),
            Self::Subaccount => quote!(::mimic::def::types::Subaccount),
            Self::Text => quote!(::mimic::def::types::Text),
            Self::Unit => quote!(::mimic::def::types::Unit),
            Self::Ulid => quote!(::mimic::def::types::Ulid),
        }
    }
